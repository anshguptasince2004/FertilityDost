      ...
      <div className="container">
        <div className="row mb-4">
          ...
          <div className="col-md-2 mb-4">
            <h6 className="title mb-3">Quick Links</h6>
            <ul className="links list-unstyled small">
          ...
          <div className="col-md-2 mb-4">
            <h6 className="title mb-3">Help & Support</h6>
            <ul className="links list-unstyled small">
          ...
          <div className="col-md-3 mb-4">
            <h6 className="title mb-3">Contact Us</h6>
            <ul className="links list-unstyled small">
          ...
          <div className="col-md-2 mb-4">
            <h6 className="title mb-3">Download The App</h6>
